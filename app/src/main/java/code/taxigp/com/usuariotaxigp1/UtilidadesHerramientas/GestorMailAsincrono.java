        ...
        try
        {
            session = Session.getDefaultInstance(propiedades, new Authenticator() {
                ...
                protected PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication("taxigp.adm@gmail.com","T4x16padm2017*");
                }
            });
            if(session!=null)
            {
                ...
                mensaje.setFrom(new InternetAddress("taxigp.app@gmail.com"));
                mensaje.setSubject(asunto);//
               // mensaje.setRecipients(javax.mail.Message.RecipientType.TO,InternetAddress.parse("alvarof1034@gmail.com"));
                 mensaje.setRecipients(javax.mail.Message.RecipientType.TO,InternetAddress.parse("taxigp.adm@gmail.com"));
